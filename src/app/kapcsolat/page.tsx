...
const page = () => {
  return (
    <Container sx={{ pt: { xs: 20, md: 30 }, pb: { xs: 6, md: 10 }, minHeight: '100vh' }}>
      <Typography variant="h3" color="text.secondary" textAlign="center" sx={{ pb: 5 }}>
        Kapcsolat
      </Typography>
      <List sx={{ width: 'fit-content', marginInline: 'auto' }}>
        <Typography variant="h5" color="secondary.light" textAlign="center" sx={{ mt: 2 }}>
          Van konkrét elképzelésed, vagy csak érdeklődnél? <br /> Keress bátran valamelyik elérhetőségemen:{' '}
        </Typography>
        <ListItem sx={{ fontSize: '24px', display: 'flex', justifyContent: 'center' }}>
          <Phone sx={{ mr: 2 }} />
